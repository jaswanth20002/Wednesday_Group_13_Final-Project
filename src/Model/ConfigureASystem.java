...
public class ConfigureASystem {
    ...
    public static EcoSystem configureABusiness() {
       ...
       // Network n3 = ecoSystem.createandAddNetwork();
        ...
        Organization  org4 = e1.getOrganizationDirectory().createOrganization(Organization.Type.Donor);
        org4.setName("Donor Department");
        Employee donor1 = org4.getEmployeeDirectory().createEmployee("Donor");
        UserAccount ua144 = org4.getUserAccountDirectory().createUserAccount();
        ua144.setPassword("donor1");
        ua144.setUsername("donor1");
        ua144.setName("donor1");
        ua144.setEmployee(donor1);
        ua144.setRole(new DonorRole());
